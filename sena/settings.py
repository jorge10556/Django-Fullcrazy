...
SECRET_KEY = 'django-insecure-d%1p&-ww6*rwnj0mbss2e0=i+gcw9%87#$@=s&xp*q0*hbv67j'
...
EMAIL_HOST_USER = "montoyarojassimon@gmail.com"  # Your email address
EMAIL_HOST_PASSWORD = "npqxcilhxnglvadv"  # Your email password
